...
typedef void(tBTA_SYS_CUST_EIR_CBACK)(const bluetooth::Uuid& uuid, bool adding);
#endif
#endif
...
extern void bta_sys_add_cust_uuid(const bluetooth::Uuid& uu);
extern void bta_sys_remove_cust_uuid(const bluetooth::Uuid& uu);
#else
