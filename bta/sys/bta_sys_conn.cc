 ...
 *
 ******************************************************************************/
void bta_sys_add_cust_uuid(const bluetooth::Uuid& uu) {
  if (bta_sys_cb.cust_eir_cb) {
    bta_sys_cb.cust_eir_cb(uu, true);
  }
}
 ...
 *
 ******************************************************************************/
void bta_sys_remove_cust_uuid(const bluetooth::Uuid& uu) {
  if (bta_sys_cb.cust_eir_cb) {
    bta_sys_cb.cust_eir_cb(uu, false);
  }
}
#endif
#endif
