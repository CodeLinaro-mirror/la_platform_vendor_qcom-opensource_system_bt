...
#define UUID_SERVCLASS_PACS 0x8FD9 /* LE AUDIO PACS */
#define UUID_SERVCLASS_ASCS 0x8FDA /* LE AUDIO ASCS */
#define UUID_SERVCLASS_BASS 0x8FDB /* LE AUDIO BASS */
#define UUID_SERVCLASS_BAAS 0x8FDC /* LE AUDIO BAAS */
#define UUID_SERVCLASS_BRASS 0x8FDD /* LE AUDIO BRASS */
#define UUID_SERVCLASS_TMAS 0x1FA0 /* LE AUDIO TMAS */
#define UUID_SERVCLASS_CSIS_LOCK 0x2B86 /* LE AUDIO CSIS LOCK */
#define UUID_SERVCLASS_TMAS_ROLE_CHAR 0xFE00 /*LE AUDIO CSIS LOCK */
#define UUID_SERVCLASS_TMAS_UMR 0xFFA1
#define UUID_SERVCLASS_TMAS_UMS 0xFFA2
#define UUID_SERVCLASS_TMAS_CG 0xFFA3
#define UUID_SERVCLASS_TMAS_CT 0xFFA4
#define UUID_SERVCLASS_TMAS_BMS 0xFFA5
#define UUID_SERVCLASS_TMAS_BMR 0xFFA6
#define UUID_SERVCLASS_TMAS_BSA 0xFFA7
#define UUID_SERVCLASS_TMAS_BSD 0xFFA8
#define UUID_SERVCLASS_HAS 0xFD00
#define UUID_SERVCLASS_SOURCE_CONTEXT 0x8F9B
#define UUID_SERVCLASS_PACS_CT_SUPPORT 0xFDE1
#define UUID_SERVCLASS_PACS_UMR_SUPPORT 0xFDE2
#define UUID_SERVCLASS_SDP_LEA 0xFAAA // TODO change to Spec Define one
