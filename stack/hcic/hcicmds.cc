...
void btsnd_hcic_rem_oob_extended_reply(const RawAddress& bd_addr,
                                       BT_OCTET16 c192,
                                       BT_OCTET16 r192,
                                       BT_OCTET16 c256,
                                       BT_OCTET16 r256) {
  ...
  BDADDR_TO_STREAM(pp, bd_addr);
  ARRAY16_TO_STREAM(pp, c192);
  ARRAY16_TO_STREAM(pp, r192);
  ARRAY16_TO_STREAM(pp, c256);
  ARRAY16_TO_STREAM(pp, r256);
