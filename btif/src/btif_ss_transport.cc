...
const char* dump_search_gatts_msgID(uint16_t msgID) {
  switch (msgID) {
    CASE_RETURN_STR(BT_LE_GATT_SERVER_REG_SERVER)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_CONNECT)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_ADD_SERVICE)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_UNREG_SERVER)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_DISCONNECT_SERVER)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_SET_PHY)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_READ_PHY)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_DELETE_SEVICE)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_SEND_INDICATION)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_STOP_SERV)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_SEND_RESPONSE)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_REG_SERVER_EVENT)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_CONN_CHNG_EVENT)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_SRV_ADD_EVENT)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_PHY_UPDATE_EVENT)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_READ_PHY_EVENT)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_SRV_DEL_EVENT)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_IND_SENT_EVENT)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_READ_CHAR_EVENT)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_RSP_SENT_EVENT)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_READ_DESC_EVENT)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_WRITE_CHAR_EVENT)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_WRITE_DESC_EVENT)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_EXEC_WRITE_EVENT)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_SRV_CONG_EVENT)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_STOP_SERVICE_EVENT)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_MTU_UPDATE_EVENT)
    CASE_RETURN_STR(BT_LE_GATT_SERVER_CONN_UPDATE_EVENT)
    default:
...
int BluetoothSSTransport::file_write(uint8_t *buf, size_t buflen, const char *msgtyp){
    ...
    else if(MSG_ID >= BT_LE_GATT_SERVER_API_START && MSG_ID <= BT_LE_GATT_SERVER_EVT_MAX)
