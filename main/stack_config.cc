...
const char* PTS_DISABLE_LOCAL_PRIVACY = "PTS_DisableLocalPrivacy";
...
static bool get_pts_local_privacy_disable(void) {
  return config_get_bool(config, CONFIG_DEFAULT_SECTION,
                         PTS_DISABLE_LOCAL_PRIVACY, false);
}
