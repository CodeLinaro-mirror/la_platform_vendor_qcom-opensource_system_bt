...
typedef void (*btrc_get_player_app_attrs_text_callback)(
    uint8_t num_attr, btrc_player_attr_t* p_attrs, RawAddress* bd_addr);
...
typedef void (*btrc_set_player_app_value_callback)(
    btrc_player_settings_t* p_vals, RawAddress* bd_addr);
...
typedef struct {
  ...
  **  3. Song position
  */
  bt_status_t (*get_play_status_rsp)(RawAddress* bd_addr,
                                     btrc_play_status_t play_status,
  ...
  */
  bt_status_t (*list_player_app_value_rsp)(RawAddress* bd_addr, int num_val,
                                           uint8_t* p_vals);

  /** Returns the current application attribute values for each of the specified
   * attr_id */
  bt_status_t (*get_player_app_value_rsp)(RawAddress* bd_addr,
  ...
  */
  bt_status_t (*get_player_app_attr_text_rsp)(
      RawAddress* bd_addr, int num_attr, btrc_player_setting_text_t* p_attrs);
  ...
  */
  bt_status_t (*get_player_app_value_text_rsp)(
      RawAddress* bd_addr, int num_val, btrc_player_setting_text_t* p_vals);
  ...
  *player
  */
  bt_status_t (*set_player_app_value_rsp)(RawAddress* bd_addr,
  ...
  bt_status_t (*set_addressed_player_rsp)(RawAddress* bd_addr,
                                          btrc_status_t rsp_status);

  /* Set browsed player response from TG to CT */
  bt_status_t (*set_browsed_player_rsp)(RawAddress* bd_addr,
                                        btrc_status_t rsp_status,
  ...
  bt_status_t (*get_folder_items_list_rsp)(RawAddress* bd_addr,
                                           btrc_status_t rsp_status,
                                           uint16_t uid_counter,
                                           uint8_t num_items,
   ...
   */
  bt_status_t (*get_item_attr_rsp)(RawAddress* bd_addr,
  ...
  bt_status_t (*get_total_num_of_items_rsp)(RawAddress* bd_addr,
                                            btrc_status_t rsp_status,
                                            uint32_t uid_counter,
                                            uint32_t num_items);

  /* Search VFS response from TG to CT */
  bt_status_t (*search_rsp)(RawAddress* bd_addr, btrc_status_t rsp_status,
...
typedef void (*btrc_passthrough_rsp_callback)(RawAddress* bd_addr, int id,
                                              int key_state);
...
typedef void (*btrc_ctrl_getrcfeatures_callback)(RawAddress* bd_addr,
                                                 int features);

typedef void (*btrc_ctrl_setabsvol_cmd_callback)(RawAddress* bd_addr,
                                                 uint8_t abs_vol,
                                                 uint8_t label);
...
typedef void (*btrc_ctrl_track_changed_callback)(
    RawAddress* bd_addr, uint8_t num_attr, btrc_element_attr_val_t* p_attrs);
...
typedef void (*btrc_ctrl_set_browsed_player_callback)(RawAddress* bd_addr,
                                                      uint8_t num_items,
                                                      uint8_t depth);
typedef void (*btrc_ctrl_set_addressed_player_callback)(RawAddress* bd_addr,
                                                        uint8_t status);
...
typedef struct {
  ...
  bt_status_t (*send_group_navigation_cmd)(RawAddress* bd_addr,
                                           uint8_t key_code, uint8_t key_state);

  /** send command to set player applicaiton setting attributes to target */
  bt_status_t (*set_player_app_setting_cmd)(RawAddress* bd_addr,
                                            uint8_t num_attrib,
                                            uint8_t* attrib_ids,
                                            uint8_t* attrib_vals);

  /** send command to play a particular item */
  bt_status_t (*play_item_cmd)(RawAddress* bd_addr, uint8_t scope, uint8_t* uid,
                               uint16_t uid_counter);
  ...
  /** set browsed player */
  bt_status_t (*set_browsed_player_cmd)(RawAddress* bd_addr,
                                        uint16_t player_id);

  /** set addressed player */
  bt_status_t (*set_addressed_player_cmd)(RawAddress* bd_addr,
                                          uint16_t player_id);

  /** send rsp to set_abs_vol received from target */
  bt_status_t (*set_volume_rsp)(RawAddress* bd_addr, uint8_t abs_vol,
                                uint8_t label);

  /** send notificaiton rsp for abs vol to target */
  bt_status_t (*register_abs_vol_rsp)(RawAddress* bd_addr,
