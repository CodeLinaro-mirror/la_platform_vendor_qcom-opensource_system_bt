...
#define BTIF_HF_CLIENT_FEATURES                                                \
  (BTA_HF_CLIENT_FEAT_ECNR |  BTA_HF_CLIENT_FEAT_3WAY |BTA_HF_CLIENT_FEAT_ECC |   \
   BTA_HF_CLIENT_FEAT_CLI | BTA_HF_CLIENT_FEAT_VOL |BTA_HF_CLIENT_FEAT_VREC | \
   BTA_HF_CLIENT_FEAT_ECS | BTA_HF_CLIENT_FEAT_CODEC | \
...
#define BTIF_HF_CLIENT_FEATURES                                                \
  (BTA_HF_CLIENT_FEAT_ECNR | BTA_HF_CLIENT_FEAT_3WAY |BTA_HF_CLIENT_FEAT_ECC |      \
   BTA_HF_CLIENT_FEAT_CLI | BTA_HF_CLIENT_FEAT_VOL |BTA_HF_CLIENT_FEAT_VREC | \
   BTA_HF_CLIENT_FEAT_ECS | BTA_HF_CLIENT_FEAT_S4)
#endif
#endif
...
static void btif_hf_client_upstreams_evt(uint16_t event, char* p_param) {
  ...
  if (cb == NULL && event == BTA_HF_CLIENT_OPEN_EVT) {
    ...
    if(NULL == cb) {
      BTIF_TRACE_ERROR("%s: event %d could ot allocate cb", __func__, event);
      return;
    }
