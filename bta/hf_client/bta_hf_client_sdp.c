...
void bta_hf_client_do_disc(void)
{
    ...
    else
    {
        ...
        bta_hf_client_cb.scb.p_disc_db_acp = (tSDP_DISCOVERY_DB *) GKI_getbuf(GKI_MAX_BUF_SIZE);
...
void bta_hf_client_free_db_int(tBTA_HF_CLIENT_DATA *p_data)
{
    ...
    if (bta_hf_client_cb.scb.p_disc_db_int != NULL)
    {
        GKI_freebuf(bta_hf_client_cb.scb.p_disc_db_int);
        bta_hf_client_cb.scb.p_disc_db_int = NULL;
    }
}
...
void bta_hf_client_free_db_acp(tBTA_HF_CLIENT_DATA *p_data)
{
    ...
    if (bta_hf_client_cb.scb.p_disc_db_acp != NULL)
    {
        GKI_freebuf(bta_hf_client_cb.scb.p_disc_db_acp);
        bta_hf_client_cb.scb.p_disc_db_acp = NULL;
    }
}
